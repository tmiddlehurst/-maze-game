...
function coordsToIndex(_ref9, width) {
...
function _getWalkableNeighbours(i, maze) {
  ...
  for (var dir in moveMap) {
    ...
    var newTile = coordsToIndex(dir(indexToCoords(i)));
  ...
  _createClass(Character, [{
    ...
    value: function _startWalk() {
      ...
      this.moveInterval = setInterval(function () {
        ...
        if ((0, _pathFinding.isWalkable)(nextTile)) {
          _this._moveTo(newTile);
...
var Baddie = function (_Character) {
  ...
  _createClass(Baddie, [{
    ...
    value: function _locatePlayer() {
      var thisPos = (0, _pathFinding.coordsToIndex)(this.position);
      var playerPos = (0, _pathFinding.coordsToIndex)(this.player.position);

      var path = (0, _pathFinding.pathFinder)(this.maze, thisPos, playerPos);
